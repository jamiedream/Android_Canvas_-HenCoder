...
public class Practice12CameraRotateFixedView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float cx1 = point1.x + bitmap.getWidth() / 2f;
        float cy1 = point1.y + bitmap.getHeight() / 2f;
        float cx2 = point2.x + bitmap.getWidth() / 2f;
        float cy2 = point2.y + bitmap.getHeight() / 2f;
